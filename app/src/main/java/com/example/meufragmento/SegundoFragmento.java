...
public class SegundoFragmento extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //variavel para subsitutir o ById
        View view = inflater.inflate(R.layout.fragment_segundo_fragmento, container, false);

        //referenciando somente dento do fragmento
        txt_contatos = view.findViewById(R.id.txt_contatos);
        txt_contatos.setText("Contatos alterados!");
        return view;
    }
}